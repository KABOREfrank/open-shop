...
<html lang="fr">
  ...
  <body>
        <nav class="navbar navbar-expand-sm navbar-dark bg-success">
            <a class="navbar-brand" href="{{ route('acceuil') }}">OpenShop</a>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId">
                ...
                <ul class="navbar-nav mt-2 mt-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="btn nav-link dropdown-toggle" href="#" id="triggerId" data-toggle="dropdown" aria-haspopup="true"aria-expanded="false">{{ Auth::user()->name }}</a>
    ...
    <main class="main-app mb-5">
            ...
            {{ $slot }} 
            {{-- il retient les autres autres pages --}}
    </main>
       <footer>
