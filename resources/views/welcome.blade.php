<x-master-layout>
    ...
    <section class="pt-5 pb-5 mt-0 align-items-center d-flex bg-dark" style="height:85vh; background-size: cover; background-image: url(https://picsum.photos/1024);">
        <div class="container-fluid">
           <div class="row  justify-content-center align-items-center d-flex text-center h-100">
             <div class="col-12 col-md-8  h-50 ">
                <h1 class="display-2  text-light mb-2 mt-5"><strong>Bienvenue sur <hr> OpenShop</strong> </h1>
